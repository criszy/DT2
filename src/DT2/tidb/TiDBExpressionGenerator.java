...
import DT2.tidb.ast.TiDBBinaryBitOperation;
import DT2.tidb.ast.TiDBBinaryBitOperation.TiDBBinaryBitOperator;
import DT2.tidb.ast.TiDBBinaryComparisonOperation;
import DT2.tidb.ast.TiDBBinaryComparisonOperation.TiDBComparisonOperator;
import DT2.tidb.ast.TiDBBinaryLogicalOperation;
import DT2.tidb.ast.TiDBBinaryLogicalOperation.TiDBBinaryLogicalOperator;
...
import DT2.tidb.ast.TiDBFunctionCall.TiDBFunction;
import DT2.tidb.ast.TiDBOrderingTerm;
import DT2.tidb.ast.TiDBRegexOperation;
import DT2.tidb.ast.TiDBRegexOperation.TiDBRegexOperator;
import DT2.tidb.ast.TiDBUnaryPostfixOperation;
import DT2.tidb.ast.TiDBUnaryPostfixOperation.TiDBUnaryPostfixOperator;
import DT2.tidb.ast.TiDBUnaryPrefixOperation;
...
//            }
            if (globalState.getSchema().getDatabaseTables().isEmpty()) {
                System.out.println(" -- generateExpression: no table");
                System.exit(1);
//                throw new IgnoreMeException();
            }
